            ...
            >
              <div
                ...
                style={{
                  ...
                  imageRendering: "pixelated",
                  boxShadow:
                    "0 0 0 3px #0a0603, 0 0 0 6px #6b4a2b, 0 0 0 9px #0a0603, 8px 8px 0 #000",
                }}
              >
                ...
                <div
                  ...
                  style={{
                    ...
                    boxShadow: "inset 0 0 0 2px #0a0603, inset 0 0 0 4px #8a6a3a",
                  }}
                >
                  {/* header */}
                              ...
                              <div className="mt-3 flex gap-[2px] h-2.5 w-full" style={{ background: "#0a0603", padding: "1px", boxShadow: "inset 0 0 0 1px #6b4a2b" }}>
                                {Array.from({ length: 10 }).map((_, i) => (
                                  <div
                                    key={i}
                                    className="flex-1"
                                    style={{ background: i * 10 < pct ? sk.color : "#1a0f06" }}
                                  />
                                ))}
                              </div>
                            </div>
